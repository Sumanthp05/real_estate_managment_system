                ...
                <div class="row">
					...
					<div class="col-lg-8">
						...
						<!-- FOR MORE PROJECTS visit: codeastro.com -->
                            ...
                            <?php
                            // Add to propertygrid.php where you want to show city properties
                            $city = "Floson"; // Or get from $_GET parameter
                            $stmt = mysqli_prepare($con, "CALL get_properties_by_city(?)");
                            ...
                            while($row = mysqli_fetch_assoc($result)) {
                                ...
                                echo $row['title'] . " - Owner: " . $row['owner_name'];
                            }
                            ?>
