                    ...
                    <form action="#" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-5 col-md-12">
								...
								<?php
									$uid = $_SESSION['uid'];
									$count_query = "SELECT get_user_property_count($uid) as total_properties";
									$count_result = mysqli_query($con, $count_query);
									$count_row = mysqli_fetch_assoc($count_result);
								?>
								<div class="card">
									<div class="card-body">
										<h4 class="card-title">Property Statistics</h4>
										<div class="stats-box">
											<p>Total Properties Listed: <?php echo $count_row['total_properties']; ?></p>
										</div>
									</div>
								</div>
                            </div>
